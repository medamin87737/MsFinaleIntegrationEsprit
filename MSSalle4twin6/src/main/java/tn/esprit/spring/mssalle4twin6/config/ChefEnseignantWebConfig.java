...
public class ChefEnseignantWebConfig implements WebMvcConfigurer {
    ...
    private static final String RESOURCE_BASE = "/salles";
    ...
    public HandlerInterceptor chefEnseignantInterceptor() {
        return new HandlerInterceptor() {
            ...
            public boolean preHandle(
                ...
                if (!underSalles(path) || "OPTIONS".equalsIgnoreCase(request.getMethod())) {
                    return true;
                }
    ...
    public void addInterceptors(@NonNull InterceptorRegistry registry) {
        registry.addInterceptor(chefEnseignantInterceptor()).addPathPatterns("/salles/**");
    }
    ...
    private static boolean underSalles(String path) {
