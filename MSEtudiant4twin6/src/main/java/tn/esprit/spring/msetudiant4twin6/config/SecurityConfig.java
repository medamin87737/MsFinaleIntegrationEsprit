...
import tn.esprit.spring.msetudiant4twin6.security.KeycloakJwtAuthenticationConverter;

/**
 * JWT Keycloak : stateless. Les règles fines utilisent {@code @PreAuthorize} sur le contrôleur.
 */
@Configuration
@EnableWebSecurity
